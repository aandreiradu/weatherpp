...
const datahumidityElement = document.querySelector('[data-humidity]');
const dataPressureElement = document.querySelector('[data-pressure]');
const dataObservationTime = document.querySelector('[data-observation_time]');
const dataMaxTemp = document.querySelector('[data-max_temp]');
const dataMinTemp = document.querySelector('[data-min_temp]');
const dataAvgTemp = document.querySelector('[data-avg_temp]');
...
function setWeatherData(data) {
    if (data) {
        ...
        windElement.textContent = data.current.wind_speed + ' km/h, Directia: ' + data.current.wind_dir;
        // myInput.value = data.location.name + ', ' + data.location.region + ', ' + data.location.country;
